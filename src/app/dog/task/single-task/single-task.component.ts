...
import { VacBuilder } from 'src/app/models/builders/vaccination.builder';
import { WormingBuilder } from 'src/app/models/builders/worming.builder';
import { Task, Vaccination, Worming, Heat, TempReading } from 'src/app/models/interfaces';
